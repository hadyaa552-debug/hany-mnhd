      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 h-16 lg:h-20 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <div className="flex flex-col items-end hidden sm:flex">
            ...
            <a href="tel:+201223147238" className="text-base font-bold text-primary hover:underline" dir="ltr">01223147238</a>
          </div>
          <a href="tel:+201223147238" className="sm:hidden bg-primary text-primary-foreground p-2.5">
